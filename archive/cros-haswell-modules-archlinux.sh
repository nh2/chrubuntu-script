...
cd linux-${kernver}
mv drivers/platform/chrome/chromeos_laptop.c drivers/platform/x86/chromeos_laptop.c
...
mv drivers/platform/x86/chromeos_laptop.c drivers/platform/chrome/chromeos_laptop.c
# Need this
cp /lib/modules/${archkernver}/build/Module.symvers .
